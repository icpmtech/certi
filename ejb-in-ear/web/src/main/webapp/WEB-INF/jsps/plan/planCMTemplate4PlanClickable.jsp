...
<s:form partial="true" beanclass="com.criticalsoftware.certitools.presentation.action.plan.PlanCMOperationsActionBean">
    <div class="template-cm-padding">
        <div class="form" style="width:100%">
            ...
            <c:url value="%3Ffolder%3D${requestScope.encodedFolderId}%26contextPath%3D${pageScope.request.contextPath}%26isTemplate4PlanClickable%3Dtrue%26insertFolderFlag%3D${requestScope.actionBean.insertFolderFlag}%26planModuleType%3D${requestScope.actionBean.planModuleType}"
                   var="params"/>
            ...
            <p>
                ...
                <s:file id="fileTemplate" name="fileTemplate4PlanClickable" class="fileInput"/>
