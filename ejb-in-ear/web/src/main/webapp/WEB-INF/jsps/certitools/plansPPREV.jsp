...
<html>
<head>
    <title><fmt:message key="home.page.link.plans.modulePPREV"/></title>
</head>
<body>
<div id="home-content">
    <div class="categories" style="text-align: justify;">
        ...
        <table border="0">
            <tr>
                <td>
                    <img src="${pageContext.request.contextPath}/images/plans-background-pprev.jpg" alt=" " width="350"
                         height="1111"/>
                </td>
                <td style="padding-left: 20px; vertical-align: top; line-height: 125%;">
                    <fmt:message key="plans.pprev.text.main"/>
                </td>
            </tr>
        </table>
    </div>
