...
//		this.tree.logDebug("dtnode.toggleSelect() - %o", this);
    ...
    fireLazyLoad: function(keyToSelect) {
		var opts = this.tree.options;
        try {
			   this.setLazyNodeStatus(DTNodeStatus_Loading);
               
                if( true == opts.onLazyRead.call(this.span, this, keyToSelect) ) {
...
//		this.tree.logDebug("_expand: end div toggle - %o", this);
	...
	toggleExpand: function() {
        this.expand(true);  //changes by @jp-gomes
...
//		this.tree.logDebug("dtnode.onClick(" + event.type + "): dtnode:" + this + ", button:" + event.button + ", which: " + event.which);
		...
		if( $(event.target).hasClass(this.tree.options.classNames.expander) ) {
            ...
            this.expand(!this.bExpanded); //changed by jp-gomes
            //this.toggleExpand();
