...
StrikeThrough		: "Eliminar da Exportação",
...
CreateDiv			: "Criar bloco <div>",	
EditDiv				: "Editar bloco <div>",	
DeleteDiv			: "Eliminar bloco <div>",
Undo				: "Anular",
Redo				: "Repetir",
...
InsertColumnAfter	: "Inserir Coluna Antes",
InsertColumnBefore	: "Inserir Coluna Depois",
DeleteColumns		: "Eliminar Coluna",
InsertCellAfter		: "Inserir Célula Antes",
InsertCellBefore	: "Inserir Célula Depois",
DeleteCells			: "Eliminar Célula",
MergeCells			: "Unir Células",
MergeRight			: "Unir à direita",
MergeDown			: "Unir abaixo",
HorizontalSplitCell	: "Dividir Células Horizontalmente",	
VerticalSplitCell	: "Dividir Células Verticalmente",	
...
VisitLinkBlocked	: "Não foi possível abrir a janela de diálogo. Certifique-se que todos os bloqueadores de popup estão desactivados.",

// Dialogs
DlgBtnOK			: "OK",
DlgBtnCancel		: "Cancelar",
DlgBtnClose			: "Fechar",
DlgBtnBrowseServer	: "Procurar",
...
DlgFindAndReplaceTitle	: "Procurar e Substituir",	
...
DlgPasteSec		: "Devido às configurações de segurança do seu navegador de internet, o editor não é capaz de aceder directamente aos dados da área de transferência. Deverá colar os dados novamente nesta janela.",	
...
DlgButtonTypeSbm	: "Submeter",	
DlgButtonTypeRst	: "Apagar",	
...
DlgTemplatesReplace	: "Substituir conteúdo actual",	
...
// Div Dialog
DlgDivGeneralTab	: "Geral",	
DlgDivAdvancedTab	: "Avançado",
DlgDivStyle		: "Estilo",	
DlgDivInlineStyle	: "Estilo Inline"
};
