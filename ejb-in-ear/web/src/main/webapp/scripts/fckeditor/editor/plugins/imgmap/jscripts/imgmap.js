...
this.props[id].innerHTML="\t\t\t\t<input type=\"text\"  name=\"img_id\" class=\"img_id\" value=\""+id+"\" readonly=\"1\"/>\t\t\t\t<input type=\"radio\" name=\"img_active\" class=\"img_active\" id=\"img_active_"+id+"\" value=\""+id+"\">\t\t\t\tShape:\t<select name=\"img_shape\" class=\"img_shape\">\t\t\t\t\t<option value=\"rect\" >rect</option>\t\t\t\t\t<option value=\"circle\"    >circle</option>\t\t\t\t\t<option value=\"poly\"   >poly</option>\t\t\t\t\t</select>\t\t\t\tCoords: <input type=\"text\" name=\"img_coords\" class=\"img_coords\" value=\"\">\t\t\t\tHref: <input type=\"text\" name=\"img_href\" class=\"img_href\" value=\"\">\t\t\t\tAlt: <input type=\"text\" name=\"img_alt\" class=\"img_alt\" value=\"\">\t\t\t\tTarget:\t<select name=\"img_target\" class=\"img_target\">\t\t\t\t\t<option value=\"\"  >&lt;not set&gt;</option>\t\t\t\t\t<option value=\"_self\"  >this window</option>\t\t\t\t\t<option value=\"_blank\" >new window</option>\t\t\t\t\t<option value=\"_top\"   >top window</option>\t\t\t\t\t</select>";
...
if(this.areas[id].shape=="circle"||this.areas[id].shape=="poly"){
...
if(this.areas[this.currentid].shape=="circle"||this.areas[this.currentid].shape=="poly"){
if(this.config.bounding_box==true){
this.areas[this.currentid].style.borderWidth="1px";
this.areas[this.currentid].style.borderStyle="dotted";
}
