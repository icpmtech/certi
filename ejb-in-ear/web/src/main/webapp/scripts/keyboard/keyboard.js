 ...
 *
 * **********************************************************
 * HTML Virtual Keyboard Interface Script - v1.21
 ...
 *
 */
var VKI_attachKeyboardInterface;

  function VKI_buildKeyboardInputs() {
    var self = this;

      //Mine
    this.VKI_showKtLayout = false;
    this.VKI_showDeadKeys = false;
    this.VKI_showCloseAndClear = false;
    this.VKI_languagesLayout = ["Portuguese", "UK"]
      //
    ...
    this.VKI_kt = "Portuguese";  // Default keyboard layout
    ...
    this.VKI_layout.Portuguese = [ // Portuguese Standard Keyboard
      [["`", "\u00ac", "\u00a6"], ["1", "!"], ["2", '"'], ["3", "\u00a3"], ["4", "$", "\u20ac"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["Delete", "Bksp"]],
    ...
    this.VKI_attachKeyboard = function(elem) {
      ...
      var keybut = document.createElement('img');
          keybut.src = "../../images/keyboard/keyboard.png";
          keybut.align = "absmiddle";
    ...
    VKI_attachKeyboardInterface = this.VKI_attachKeyboard;
    ...
    for (var x = 0, elem; elem = inputElems[x++];)
      for (var y = 0, ex; ex = elem[y++];)
        if ((ex.nodeName == "TEXTAREA" || ex.type == "text" || ex.type == "password" || ex.type == "hidden") && ex.className.indexOf("keyboardInput") > -1)
    ...
    //Removed this because it changes the beahavior in IE 
    /*
